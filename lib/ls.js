...
var parse = function(code, filename) {
    ...
    var parser = function() {
        ...
        while (pos < length) {
            ...
            if ((c == '‘' && !isSingleString) || (c == '’' && isSingleString)) {
                isSingleString = !isSingleString;
                token += "'";
                continue;
            }
...
var handleOperator = function(arr) {
	...
	_.each(operatorReplacements, function(replacement, original) {
        if (arr[0] == original) arr[0] = replacement;
    })
